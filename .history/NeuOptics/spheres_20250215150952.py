...
def _N_sphere_projection(N: Union[np.ndarray, nr.Tree_graph], sphere: Union[vd.Sphere, None] = None, r: Union[float, None] = None, c:Union[np.ndarray, None] = None, bind: bool = False) -> np.ndarray:
